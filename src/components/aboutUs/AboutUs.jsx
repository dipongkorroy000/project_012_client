  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-12 text-gray-800">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        {/* Roles */}
        <div className="bg-base-200 p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold text-accent">🧑‍💼 Roles & Rewards</h3>
          <p className="mt-2 text-sm text-gray-300">
        ...
        {/* Security */}
        <div className="bg-base-200 p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold text-accent">🔒 Security & Trust</h3>
          <p className="mt-2 text-sm text-gray-300">
            Stripe-powered payments, role-based access, and admin oversight ensure a safe and reliable experience for all users.
          </p>
        </div>
      </div>
